namespace :db do
  ...
  task :populate => :environment do
    ...
    #                    :educations => Faker::Company.name,)
    #
    #  participants = Participant.create!(:user_id => user.id,:conference_id => "1")
    #
    #
    #  )
    #end
    ...
    #participants = Participant.create!(:user_id => 1+rand(100),
    #                                   :conference_id => "1"
    #)

  #  3.times do |event_day|
  #    event_day = EventDay.create!(:name => Faker::Name.name,
  #                                 :conference_id => "1",
  #                                 :sequence =>  1+rand(3),
  #                                 #:meeting_id => 1+rand(50)
  #
  #    )
  #end
