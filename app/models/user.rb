class User < ActiveRecord::Base
  ...
  attr_accessible :skills, :provider, :uid, :name, :location, :industry, :picture, :token, :secret, :headline, :positions, :educations,  :avatar, :batchie,:industry_recco ,:location_recco, :company,:no_of_views,:recommend,:role,:recommend_select,:interest,:user_photo,:person_view
